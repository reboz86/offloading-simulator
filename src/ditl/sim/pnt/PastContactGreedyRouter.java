...
public class PastContactGreedyRouter extends Router implements Generator, PresenceTrace.Handler,LinkTrace.Handler{
	...
	public PastContactGreedyRouter(PervasiveInfraRadio infraRadio, long panicInterval, Integer id, int bufferSize, Bus<BufferEvent> bus) {
